      ...
      <div className="parent w-100 h-102 bg-zinc-900 text-white rounded-xl">
        <div className="top flex justify-between text-white p-5 w-full">
          <img
            ...
            src="https://images.unsplash.com/photo-1769399287930-7cdddd98ef3a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
          <div className="saves">
        ...
        <div className="bottom border-t-2 border-gray-100/50 flex justify-between mt-20 p-5">
          <div>
            <h1>$120/hr</h1>
            <h4 className="text-[13px] opacity-50">Mumbai, India</h4>
          </div>
